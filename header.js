    ...
    render() {
        ...
        @font-face {
            ...
            :host {
                ...
                display: block;
                font-family: 'Circular Std', system-ui, -apple-system, sans-serif; /* Ensure font consistency */
            }
                        ...
                        <ul class="cronos-custom-nav-list">
                            ...
                            <li class="cronos-custom-nav-item--has-megamenu">
                                ...
                                <div class="cronos-mega-menu-container">
                                    <div class="cronos-mega-menu-panel" data-cronos-megamenu-panel="crypto">
                                        <div class="cronos-megamenu-3-column-grid">
                                            ...
                                            <div class="cronos-menu-group-card">
                                                ...
                                                <ul class="cronos-mega-menu-group-list">
                                                    ...
                                                    <li>
                                                        <a href="page.html">
                                                            <span class="cronos-mega-menu-link-title">Liquidity Converter</span>
                                                            </a>
                                                    </li>
                                                    <li>
                                                        <a href="page.html">
                                                            <span class="cronos-mega-menu-link-title">DeFi & NFT</span>
                                                            </a>
                                                    </li>
                                                    <li>
                                                        <a href="careers.html">
                                                            <span class="cronos-mega-menu-link-title">Market Insights</span>
                                                            </a>
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div class="cronos-mega-menu-panel" data-cronos-megamenu-panel="services">
                    <div class="cronos-megamenu-3-column-grid">
                        ...
                        <div class="cronos-menu-group-card">
                            ...
                            <ul class="cronos-mega-menu-group-list">
                                <li>
                                    <a href="managed-it-services.html">
                                        <span class="cronos-mega-menu-link-title">Managed IT Services & Helpdesk</span>
                                        </a>
                                </li>
                                <li>
                                    <a href="it-consulting.html">
                                ...
                                <li>
                                    <a href="cloud-infrastructure.html">
                                        <span class="cronos-mega-menu-link-title">Cloud Infrastructure</span>
                                        </a>
                                </li>
                                <li>
                    ...
                    <div class="cronos-megamenu-3-column-grid">
                        ...
                        <div class="cronos-menu-group-card">
                            ...
                            <ul class="cronos-mega-menu-group-list">
                                ...
                                <li>
                                    <a href="page.html">
                                        <span class="cronos-mega-menu-link-title">Crypto Market Updates</span>
                                        </a>
                                </li>
                                <li>
                                    <a href="page.html">
                                        <span class="cronos-mega-menu-link-title">Bitcoin for Web3</span>
                                        </a>
                                </li>
                            </ul>
                        </div>
